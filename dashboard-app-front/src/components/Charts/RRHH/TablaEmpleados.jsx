...
const TablaEmpleados = ({ empleados }) => {
    ...
    const empleadosAMostrar = empleados.slice(inicio, inicio + empleadosPorPagina);
                    ...
                    <table className="min-w-full text-sm text-left">
                        <thead className="border-b dark:border-gray-700">
                            <tr>
                                ...
                                <th className="py-2 px-4">Asistencias</th>
                            </tr>
                        </thead>
                        <tbody>
                            {empleadosAMostrar.map((empleado) => (
                                <tr key={empleado.id} className="border-b dark:border-gray-700">
                                    ...
                                    <td className="py-2 px-4">{empleado.asistencias}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
