...
const ModalReportePDFAdmin = ({ isOpen, onClose }) => {
    ...
    const generarReporte = async () => {
        ...
        try {
            const res = await fetch(
                `http://localhost:4000/api/administracion/reportes-pdf?inicio=${fechaInicio.toISOString()}&fin=${fechaFin.toISOString()}`,
                {
                    headers: { 
            ...
            const nombreArchivo = `Reporte_Finanzas_${fechaStr}_${horaStr}.pdf`;
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className="w-full max-w-3xl px-4">
                <h3 className="text-xl font-semibold mb-6">Generar reporte financiero</h3>
...
export default ModalReportePDFAdmin;
