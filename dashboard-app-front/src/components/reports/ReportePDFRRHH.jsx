...
const ModalReportePDFRRHH = ({ isOpen, onClose }) => {
    ...
    const generarReporte = async () => {
        ...
        try {
            const res = await fetch(
                `http://localhost:4000/api/rrhh/reportes-pdf?inicio=${fechaInicio.toISOString()}&fin=${fechaFin.toISOString()}`,
                {
                    headers: { 
            ...
            const nombreArchivo = `Reporte_RRHH_${fechaStr}_${horaStr}.pdf`;
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className="w-full max-w-3xl px-4">
                <h3 className="text-xl font-semibold mb-6">Generar Reporte de Recursos Humanos</h3>
...
export default ModalReportePDFRRHH;
